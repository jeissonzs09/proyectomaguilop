...
<head>
    <meta charset="utf-8">
    <title>Listado de Reparaciones | MAGUILOP</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="metadata">
        ...
        <p><strong>Total de Registros:</strong> {{ count($reparaciones) }} registros</p>
    </div>

    <div class="divider"></div>

    <h2 class="final-title">Listado de Reparaciones</h2>
