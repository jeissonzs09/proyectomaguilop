<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-bold">✏️ Editar Compra #{{ $compra->CompraID }}</h2>
    </x-slot>
    ...
    <div class="p-6 max-w-3xl mx-auto bg-white shadow-md rounded-md">
        <form action="{{ route('compras.update', $compra->CompraID) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="number" name="ProveedorID" id="ProveedorID" value="{{ old('ProveedorID', $compra->ProveedorID) }}" required
            ...
            <div>
                ...
                <input type="number" name="EmpleadoID" id="EmpleadoID" value="{{ old('EmpleadoID', $compra->EmpleadoID) }}" required
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
            ...
            <div>
                ...
                <input type="datetime-local" name="FechaCompra" id="FechaCompra" value="{{ old('FechaCompra', \Carbon\Carbon::parse($compra->FechaCompra)->format('Y-m-d\TH:i')) }}" required
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
            ...
            <div>
                ...
                <input type="number" step="0.01" name="TotalCompra" id="TotalCompra" value="{{ old('TotalCompra', $compra->TotalCompra) }}" required
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
