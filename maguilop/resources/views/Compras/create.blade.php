        ...
        <form action="{{ route('compras.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="ProveedorID" id="ProveedorID" required
                    ...
                    <option value="" disabled {{ old('ProveedorID') ? '' : 'selected' }}>Seleccionar proveedor</option>
            ...
            <div>
                ...
                <select name="EmpleadoID" id="EmpleadoID" required
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    <option value="" disabled {{ old('EmpleadoID') ? '' : 'selected' }}>Seleccionar empleado</option>
            ...
            <div class="mt-6 text-end">
                <a href="{{ route('compras.index') }}"
                   class="bg-red-600 text-white font-bold py-2 px-4 rounded inline-flex items-center mr-2">
                   ❌ Cancelar
                </a>
                <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center gap-2 shadow">
                    💾 Guardar Compra
                </button>
            </div>
        </form>
